...
python train.py --wandb "" --proj_dir $PROJ_DIR \
 --data_file "data/minipile" --data_type "binidx" --vocab_size 256 --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --init_model 1 --epoch_count 1 \
 --epoch_step_save 10 --weight_decay 0 --head_size_a 64 \
